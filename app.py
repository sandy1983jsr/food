...
st.set_page_config(page_title="Dairy Energy Digital Twin", layout="wide")
set_custom_style()

st.title("🧑‍🔬 Dairy Plant Energy Digital Twin")
st.sidebar.image("https://heritagefoods.in/img/logo.png", width=180)
st.sidebar.markdown("## Navigation")
tab_names = ["Refrigeration & Chilling", "Pasteurization/Boilers", "Water Heating & CIP", "Air Compressors", "Lighting & HVAC", "Alerts", "AI Recommendations"]
